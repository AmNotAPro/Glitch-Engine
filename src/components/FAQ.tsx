...
const FAQ = () => {
  ...
  return (
    <section id="faq" className="py-16 md:py-24 lg:py-32 bg-background-white">
      <div className="container mx-auto px-6 md:px-8 lg:px-12 max-w-4xl">
        <h2 className="text-4xl md:text-5xl font-bold text-text-primary text-center mb-12 md:mb-16">
        ...
        <div className="space-y-4">
          {faqItems.map((item, index) => (
            <div
              key={index}
              className="border border-border-light rounded-lg overflow-hidden bg-background-white shadow-sm hover:shadow-md transition-shadow"
            >
              <button
