/*
# Clean Admin System Schema for Glitch Engine
# Admin: Hard-coded (admin@gmail.com/123456) - NOT stored in database
# Users: Stored in Supabase with Client role only
# Admin controls everything via Supabase queries

## What this creates:
1. user_profiles table (Client role only)
...
7. Admin can control everything via direct queries
*/
...
-- Admin can manage all candidates (bypasses RLS via service role)
...
DO $$
BEGIN
    RAISE NOTICE '✅ Clean admin system schema created successfully!';
    RAISE NOTICE '🔐 Admin login: admin@gmail.com / 123456 (hard-coded, not in database)';
