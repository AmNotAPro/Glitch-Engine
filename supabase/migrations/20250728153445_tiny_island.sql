...
# This creates everything needed for admin + user system

## What this does:
1. Creates clean tables (user_profiles, job_postings, candidates, meetings)
2. Creates admin account in auth.users
3. Creates admin profile in user_profiles  
4. Sets up RLS policies
5. Creates auto profile creation trigger
*/
